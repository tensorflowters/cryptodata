...
MAKE_PROD_EXECUTOR_REGISTERY=make -f commands/docker-build.prod.mk
...
prod_build_registery_all:
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-airflow
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-binance-scraper
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-client_initdb
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-cryptopanic-scraper
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-scraped_consumer
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-sentiment_analysis
	@${MAKE_PROD_EXECUTOR_REGISTERY} build_cryptodata-wss
